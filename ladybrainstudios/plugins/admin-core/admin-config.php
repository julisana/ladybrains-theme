...
$sections[] = array(
	...
	'fields' => array(
		...
		array(
			...
			'subtitle' => __('Choose background color for blog footer.', 'oneengine'),
			'default' => '#cccccc',
			'transparent'=>false,
			'validate' => 'color',
		),
		array(
			'id'=>'footer_blog_opacity',
			'type' => 'button_set',
			'title' => __('Background Color opactiy for Footer', 'oneengine'),
			'subtitle' => __('Choose opacity for background color.', 'oneengine'),
			'default' => '1',
			'options' => array(
				'0' => __('0%','oneengine'),
				'.1' => __('10%','oneengine'),
